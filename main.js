...
function hide_proyectos() {
  contenedor.classList.toggle('is_flipped');
  document.querySelector(".texto_flecha").scrollIntoView({ behavior: 'smooth' });
}

function hide_acerca_de_mi() {
  contenedor.classList.toggle('is_flipped');
  document.querySelector(".scroll_to_perfil").scrollIntoView({ behavior: 'smooth' });
}
...
const objeto5 = document.querySelectorAll('.flecha_arriba');
